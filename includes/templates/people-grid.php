            ...
            <?php endif ?>
                <div class="pull-left profile-picture-item avatar" data-userid="<?= $person->getId() ?>">
                    <?php if ($user->isLoggedIn()): ?>
                        ...
                        <?php else: ?>
                            <a href="<?= BASE_URL ?>?view=favorite&id=<?= $person->getId() ?>&action=create" class="glyphicon glyphicon glyphicon-heart-empty favorites-toggle" data-favorite="false" aria-hidden="true"></a>
                        <?php endif ?>
                    <?php else: ?>
